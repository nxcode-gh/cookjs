export function randomString(start:number, end:number){
...
export function removeValueFromArray(arr:Array<any>, value:any) {
...
export function sortArrayBy (data:any, byKey:any){
